...
class Grade extends BEN_General {
    ...
    public function index(){
        ...
        $this->data['all_data']= $this->subject_model->multiple_join(array('grade','company'));
    ...
    public function save(){
        if($_REQUEST){
            ...
            if($this->company_model->create("grade",$_REQUEST[$this->current_page['controller']])){
    ...
    public function update_save(){
        if($_REQUEST){
            ...
            if($this->subject_model->update("grade",$_REQUEST[$this->current_page['controller']])){
