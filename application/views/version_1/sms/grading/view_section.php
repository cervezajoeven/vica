    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="top: -10px;position: relative;"><img style="height: 41px;display: inline;" src="<?php $general_class->ben_resources('images/general/school.png') ?>"><p style="
    display: inline;
    top: -7px;
    position: relative;
...
">Campus Management System</p></a>
            ...
            <!-- Default Example -->
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Grade <?php echo $general_class->data['grade']?> - <?php echo $general_class->data['section']?>
                        ...
                        <div class="body">
                            <?php foreach($general_class->data['students'] as $student_key=>$student_value): ?>

                                <iframe id="form-138" src="<?php echo $general_class->ben_link('sms/grading/form_138_print') ?>/<?php echo $general_class->data['schoolyear']?>/<?php echo $general_class->data['semester']?>/<?php echo $general_class->data['grade']?>/<?php echo $general_class->data['section']?>/<?php echo $student_value['gender']?>/<?php echo $student_value['account_id']?>"></iframe>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $("#print").click(function(){
            $("#form-138").get(0).contentWindow.print();
        });
    </script>
