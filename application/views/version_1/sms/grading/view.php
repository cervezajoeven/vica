            ...
            <!-- Default Example -->
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?php echo $general_class->data['profile']['first_name'] ?> <?php echo $general_class->data['profile']['last_name'] ?>
                        ...
                        <div class="body">
                            <iframe id="form-138" src="<?php echo $general_class->ben_link('sms/grading/form_138_print') ?>/<?php echo $general_class->data['schoolyear']?>/<?php echo $general_class->data['semester']?>/<?php echo $general_class->data['grade']?>/<?php echo $general_class->data['section']?>/<?php echo $general_class->data['gender']?>/<?php echo $general_class->data['account_id']?>"></iframe>
                        </div>
                    </div>
                </div>
        </div>
