...
<div class="brainee-page_container col-lg-12">
	...
	<div class="brainee-page">
		<div class="container">
			...
			<?php $field = "grade_id" ?>
			<div class="form-group">
				<label for="<?php echo $field?>">Grade</label>
				<select required="" name="section[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
					<option value="">Select Grade</option>
					<?php foreach($general_class->data['grade_data'] as $all_data_key=>$all_data_value): ?>
						<option value="<?php echo $all_data_value['id']?>">Grade <?php echo ucwords($all_data_value['grade_name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			...
			<?php if($general_class->session->userdata('company_id') == 1): ?>
				...
				<div class="form-group">
					...
					<select name="section[company_id]" class="form-control" required="" placeholder="Select">
				...
				<div class="form-group">
					...
					<select name="section[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
