	...
	<div class="brainee-page_container col-lg-12">
		<div class="brainee-page_titlebar">
			<div class="brainee-page_titlebar_title">
				<span><?php echo $general_class->page_title ?> (View) </span>
			</div>
			<div class="brainee-page_titlebar_controls_container">
				<a href="<?php echo $general_class->ben_link($general_class->module_folder.'/'.strtolower($general_class->view_folder)); ?>/index"><button type="button" class="btn btn-primary" id="action_add">Back</button></a>
			</div>
		</div>
		...
		<div class="brainee-page">
			<div class="container">
				...
				<div class="form-group">
					...
					<input type="text" value="<?php echo $update_data['module'] ?>" name="module" class="form-control" required="" placeholder="Module" readonly />
				</div>
				<div class="form-group">
					<label for="controller">Controller</label>
					<input type="text" value="<?php echo $update_data['controller'] ?>" name="controller" class="form-control" required="" placeholder="Controller" readonly />
				</div>
				<div class="form-group">
					<label for="action_function">Function</label>
					<input type="text" value="<?php echo $update_data['action_function'] ?>" name="action_function" class="form-control" required="" placeholder="Function" readonly/>
				</div>
				<div class="form-group">
					<label for="account_type_id">Account Type</label>
					<select name="account_type_id" class="form-control" required="" placeholder="Select" disabled="">
				...
				<div class="form-group">
					...
					<select name="status" class="form-control" required="" placeholder="Select" disabled="">
