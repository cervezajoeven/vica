<?php $data = $general_class->data['data']?>
	...
	<div class="brainee-page">
		<div class="container">
			...
			<div class="form-group">
				<input type="hidden" value="<?php echo $data[$field]?>" id="<?php echo $field?>" name="<?php echo $field?>" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>

			<?php $field = "announcement_title" ?>
			<div class="form-group">
				<label><?php echo underscore_convert(ucfirst($field)); ?></label>
				<input type="text" value="<?php echo $data[$field]?>" id="<?php echo $field?>" name="<?php echo $field?>" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>
