<?php echo $general_class->ben_open_form("general/".$general_class->current_page['controller']."/save/".$general_class->data['account_id']); ?>
<div class="brainee-page_container col-lg-12">
	...
	<div class="brainee-page">
		<div class="container">
			...
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="text" id="<?php echo $field?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>
			...
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="email" id="<?php echo $field?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control"  placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>

			<?php $field = "contact_number" ?>
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="number" id="<?php echo $field?>" min="1" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>
