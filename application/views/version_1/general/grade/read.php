		...
		<div class="brainee-page">
			<div class="container">
				...
				<div class="form-group">
					...
					<input disabled="" type="text" value="<?php echo $update_data[$field] ?>" id="<?php echo $field?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
				</div>
				<div class="form-group">
					<?php $field = "company_id" ?>
					<label for="<?php echo $field?>">Company</label>
					<select disabled="" name="grade[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
