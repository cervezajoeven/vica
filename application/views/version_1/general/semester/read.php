		...
		<div class="brainee-page">
			<div class="container">
				...
				<div class="form-group">
					...
					<input type="text" readonly value="<?php echo $update_data['account_type_name'] ?>" name="account_type_name" class="form-control" required="" placeholder="Module" />
				</div>
				<div class="form-group">
					<label for="company_id">Company</label>
					<select name="company_id" disabled="" class="form-control" required="" placeholder="Select">
