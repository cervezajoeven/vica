	...
	<div class="brainee-page">
		<div class="container">
			...
			<div class="form-group">
				...
				<input type="text" id="<?php echo $field?>" value="<?php if(is_array($value)){echo $value[$field]; }?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>

			<?php $field = "semester_order" ?>
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="text" id="<?php echo $field?>" value="<?php if(is_array($value)){echo $value[$field]; }?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>
			...
			<div class="form-group">
				...
				<!-- <pre> -->
				<?php //print_r($general_class->data['all_data']); ?>
