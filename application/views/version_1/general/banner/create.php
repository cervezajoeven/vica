...
<div class="brainee-page_container col-lg-12">
	...
	<div class="brainee-page">
		<div class="container">
			...
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="number" min="1" id="<?php echo $field?>" name="<?php echo $field?>" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>
			...
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="file" id="<?php echo $field?>" name="<?php echo $field?>" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
			</div>
