...
<script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/bootstrap-notify/bootstrap-notify.js"></script>
...
<script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/sweetalert/sweetalert.min.js"></script>

<script src="<?php echo $general_class->ben_resources('sms'); ?>/js/pages/ui/sortable-nestable.js"></script>
<script src="<?php echo $general_class->ben_resources('sms'); ?>/js/pages/ui/dialogs.js"></script>
