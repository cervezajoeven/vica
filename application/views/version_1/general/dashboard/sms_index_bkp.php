...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Campus Management System</a>
            </div>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Timekeeping</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Absences</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Lates</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Salary</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Benefits</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Loans</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Advances</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Subject Loads</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Trainings</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Evaluation</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Leaves</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Sick Leave</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Maternity Leave</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Paternity Leave</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Teaching</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Non Teaching</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html"></a>
                                    </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Attendance</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Leave</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Absences</a>
                                    </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/cards/basic.html">Lesson Packages</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/colored.html">Lesson Creation</a>
                                    </li>
                                    <li>
                                        <a href="pages/widgets/cards/no-header.html">Lesson Bank</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">NEW LESSONS</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">NEW ASSESSMENTS</div>
    ...
    <!-- Morris Plugin Js -->
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/raphael/raphael.min.js"></script>
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/morrisjs/morris.js"></script>

    <!-- ChartJs -->
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/chartjs/Chart.bundle.js"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/flot-charts/jquery.flot.js"></script>
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/flot-charts/jquery.flot.resize.js"></script>
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/flot-charts/jquery.flot.pie.js"></script>
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/flot-charts/jquery.flot.categories.js"></script>
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/flot-charts/jquery.flot.time.js"></script>

    <!-- Sparkline Chart Plugin Js -->
    <script src="<?php echo $general_class->ben_resources('sms'); ?>/plugins/jquery-sparkline/jquery.sparkline.js"></script>
