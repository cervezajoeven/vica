                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="http://stepsmandaluyong.com/brainee/index.php/version_1/general/dashboard/sms_index"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/forms/basic-form-elements.html">Admission</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">
