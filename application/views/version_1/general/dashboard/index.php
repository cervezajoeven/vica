...
<div class="home">
        ...
        <div class="brainee-announcement">
            <div class="brainee-announcement_titlebar_container">
                <div class="brainee-announcement_titlebar">
                    <img src="http://warehows.net/sanisidro/resources/version_1/images/general/school.png" />
                    Announcements
                </div>
            </div>
    ...
    <div class="col-lg-12 main-box">
        <a href="<?php echo $general_class->ben_link('general/dashboard/about_us'); ?>">
            <div class="col-lg-3 box">
                <i class="glyphicon glyphicon-user icon"></i>
                <div class="box_title">About Us</div>
            </div>
        </a>
        <a href="<?php echo $general_class->ben_link('general/memo/view'); ?>">
            <div class="col-lg-3 box">
        ...
        <div class="col-lg-3 box">
            <a href="<?php echo $general_class->ben_link('general/dashboard/calendar'); ?>">
