<?php $update_data = $general_class->data['lesson_data']; ?>
...
<div class="brainee-page_container col-lg-12">
	...
	<div class="brainee-page">
		<div class="container">
			<input type="hidden" name="lesson[id]" value="<?php echo $update_data['id']; ?>" />
			<?php $field = "lesson_name" ?>
			<div class="form-group">
				<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
				<input type="text" id="<?php echo $field?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" value="<?php echo $update_data['lesson_name']?>" required="" placeholder="<?php echo ucwords(underscore_convert($update_data['lesson_name']))?>" />
			</div>
			...
			<div class="form-group">
				...
				<select required="" name="<?php echo $general_class->current_page['controller'] ?>[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
					...
					<?php foreach($general_class->data[$field_name.'_data'] as $all_data_key=>$all_data_value): ?>
						<option value="<?php echo $all_data_value['id']?>" <?php if($all_data_value['id']==$update_data['subject_id']){ echo "selected"; } ?> ><?php echo ucwords($all_data_value[$field_name.'_name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			...
			<div class="form-group">
				...
				<select required="" name="<?php echo $general_class->current_page['controller'] ?>[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
					<option value="">Select <?php echo ucfirst($field_name); ?></option>
					<?php foreach($general_class->data[$field_name.'_data'] as $all_data_key=>$all_data_value): ?>
						<option value="<?php echo $all_data_value['id']?>" <?php if($all_data_value['id']==$update_data[$field]){ echo "selected"; } ?> >Grade <?php echo ucwords($all_data_value[$field_name.'_name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			...
			<div class="form-group">
				...
				<select required="" name="<?php echo $general_class->current_page['controller'] ?>[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
					<option value="">Select <?php echo ucfirst($field_name); ?></option>
					<?php foreach($general_class->data[$field_name.'_data'] as $all_data_key=>$all_data_value): ?>
						<option value="<?php echo $all_data_value['id']?>" <?php if($all_data_value['id']==$update_data[$field]){ echo "selected"; } ?> ><?php echo ucwords($all_data_value[$field_name]); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
