		...
		<div class="form-group" style="width: 80%">
			<div class="input-group">
				<span class="input-group-addon <?php if($correct[$option_key]=='1'): echo "green"; endif; ?>">
					<input type="checkbox" name="checkbox_<?php echo $option['id']?>" <?php if($correct[$option_key]=='1'): echo "checked='checked'"; endif; ?> value="<?php echo $correct[$option_key]; ?>" disabled />
				</span>
