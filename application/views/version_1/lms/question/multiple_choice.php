		...
		<div id="container">
			...
			<div class="col-lg-12 col-centered">
				...
				<div class="form-group">
					...
					<input class="form-control" required="" placeholder="Score" value="1" type="number" min="1" required="" name="points">
				</div>
			         		...
			         		<td>
			         			<div class="input-group">
			               			<span class = "input-group-addon">
			                  			<input class="form-check-input" name="correct" value="1" type="radio" id="mcq_radio">
			               			</span>
