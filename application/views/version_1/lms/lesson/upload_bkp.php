...
<?php $lesson_folders = array("Induction","Follow-Up Activity","Lesson Proper","Drill","Evaluation","Wrapping-Up & Valuing"); ?>
<body>
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <?php endforeach; ?>
                <!-- <li class="sidebar-brand">
                    <a href="<?php echo $general_class->ben_link('lms/lesson_assign/index/'.$views_data['lesson_id']); ?>">
                            ...
                            <div class="tab-content">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php if($views_data['file_data']): ?>
                                        ...
                                        <?php elseif($category=="ppt"): ?>
                                            <iframe src="https://docs.google.com/gview?url=http://braineelms.com/brainee/resources/uploads/lessons/lesson_1_5/1-7-MultDecimals-1.ppt" style="width:600px; height:500px;"></iframe>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
