	...
	<div class="brainee-page_container col-lg-12">
		...
		<div class="brainee-page">
			<div class="container">
				...
				<?php $field = "subject_name" ?>
				<div class="form-group">
					<label for="<?php echo $field?>"><?php echo ucwords(underscore_convert($field))?></label>
					<input readonly="" type="text" value="<?php echo $update_data[$field] ?>" id="<?php echo $field?>" name="<?php echo $general_class->current_page['controller']?>[<?php echo $field?>]" class="form-control" required="" placeholder="<?php echo ucwords(underscore_convert($field))?>" />
				</div>
				<div class="form-group">
					<?php $field = "company_id" ?>
					<label for="<?php echo $field?>">Company</label>
					<select disabled="" name="subject[<?php echo $field?>]" class="form-control" required="" placeholder="Select">
				...
				<?php if($general_class->session->userdata('company_id') == 1): ?>
					...
					<div class="form-group">
						...
						<select disabled="" ="" name="status" class="form-control" required="" placeholder="Select">
