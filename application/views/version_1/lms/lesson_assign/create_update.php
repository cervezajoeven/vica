<div class="row clearfix">
    <div class="col-sm-12">
        <div class="card">
            ...
            <?php echo $general_class->ben_open_form("lms/".$general_class->current_page['controller']."/update_save/".$data['lesson_id']."/".$data['lesson_assign']['id']); ?>
            	<?php $assigned_students = $general_class->data['assigned_students']; ?>
				<?php $date_start = date('Y-m-d H:i:s',strtotime($data['lesson_assign']['start_date'])); ?>
				<?php $date_end = date('Y-m-d H:i:s', strtotime($data['lesson_assign']['end_date'])); ?>
                <div class="header">
                    <div class="row clearfix">
