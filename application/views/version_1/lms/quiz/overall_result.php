<div class="brainee-page_container col-lg-12">
	...
	<div class="col-lg-12">
		<div class="form-group">
			<a href="<?php echo $general_class->ben_link('lms/quiz/results/'); ?>"><button id="results" class="form-control btn btn-warning">View Answer Sheet</button></a>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function one() {
		...
		$("#results").parent().attr("href",the_href+attempt_id+'/'+quiz_id_real);
