<style type="text/css">
	...
	.brainee-page_titlebar_controls_container a:nth-child(2){
		right: 55px;
	}
</style>
...
<script type="text/javascript">
	...
	function one() {
		...
		var check_url = '<?php echo $general_class->ben_link("lms/quiz/check_if_assigned/"); ?>'+quiz_id;
