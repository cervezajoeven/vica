	...
	<div class = "container-fluid">
      	<div class = "row row-height">
	        <div class = "col-sm-6 left">
	        		...
	        		<?php if($this->session->userdata('account_type_id')==5){ $back_button = 'lms/quiz/student_quiz_history'; } else { $back_button = 'lms/quiz/results/'.$data['quiz_id']."/".$data['section_id']; } ?>
		        	<a href="<?php echo $general_class->ben_link($back_button)?>"><button class="reupload btn btn-danger form-control" type="button"> < Back</button></a>
	        	<?php if($general_class->data['account_type_id']!=5):?>
		        	<button type="button" class="reupload btn btn-success form-control">Reupload</button>
	        ...
	        <div class="col-sm-6 right">
	        	<table class="table table-bordered table-striped" style="margin:0">
	        		<tr>
	        			...
	        			<td><b>Score : </b></td>
	        			<td><span id="actual_score"></span> / <span id="total_score"></span></td>
	        		</tr>
	        		<tr>
	        	...
	        	<?php $general_class->ben_html("keys_review"); ?>
